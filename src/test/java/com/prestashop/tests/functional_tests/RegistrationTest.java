...
public class RegistrationTest extends TestBase {
    ...
    public void registrationTest() throws InterruptedException {
        ...
        Thread.sleep(500);
        Assert.assertEquals(actualEmail, FAKE_EMAIL);
        ...
        //password
        WebElement password = driver.findElement(By.id("passwd"));//passwordField
        ...
        //phone
        WebElement phone_number = driver.findElement(By.id("phone_mobile"));//phone
...
//   //driver.findElement(By.id("authentication")).sendKeys("Abed");//?????
        ...
        Assert.assertEquals(FIRST_NAME, str[0]);
        Assert.assertEquals(LAST_NAME, str[1]);
...
//   11.VERIFY that personal information is displayed correctly
        ...
        Thread.sleep(500);
        Assert.assertEquals(first, FIRST_NAME);

        //check last name
        driver.findElement(By.id("lastname")).click();
        String last = driver.findElement(By.id("lastname")).getAttribute("value");
        Thread.sleep(500);
        Assert.assertEquals(last, LAST_NAME);

        //verify email
        driver.findElement(By.id("email")).click();
        String email = driver.findElement(By.id("email")).getAttribute("value");
        Thread.sleep(500);
        Assert.assertEquals(FAKE_EMAIL, email);
        ...
        String zip2 = driver.findElement(By.xpath("//*[@id=\"center_column\"]/div[1]/div/div/ul/li[5]/span[3]")).getText();
...
//        //15.Login using the email and password of the current user
        driver.findElement(By.xpath("//*[@id='email']")).sendKeys(FAKE_EMAIL);
...
//       16.Verify that correct first and last name is displayed correctly on top right
        ...
        Assert.assertEquals(FIRST_NAME, str2[0]);
        Assert.assertEquals(LAST_NAME, str2[1]);
    }
